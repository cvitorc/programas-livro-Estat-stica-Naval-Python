...
# -*- coding: utf-8 -*-
"""
Created on Wed Jan  1 21:44:35 2025
...
# Análise de outliers usando o intervalo interquartil (IQR)
Q1 = np.percentile(velocidades, 25)  # Primeiro quartil (25%)
Q3 = np.percentile(velocidades, 75)  # Terceiro quartil (75%)
IQR = Q3 - Q1  # Intervalo interquartil

limite_inferior = Q1 - 1.5 * IQR  # Limite inferior para outliers
limite_superior = Q3 + 1.5 * IQR  # Limite superior para outliers

# List comprehension para detectar outliers
# Para cada valor 'v' na lista 'velocidades', verifica se 'v' está fora dos limites calculados (menor que o limite inferior ou maior que o limite superior)
# Se a condição for verdadeira, o valor 'v' é adicionado à lista de outliers.
outliers = [v for v in velocidades if v < limite_inferior or v > limite_superior]

# Exibe a lista de outliers detectados
